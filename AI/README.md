...
### I2T（Image To Text 图像内容识别为自然语言文本）| [Explore](./I2T/)

**定位：** 利用计算机视觉（CV）与自然语言处理（NLP）跨模态融合技术，将图像内容直接翻译或理解为自然语言文本输出

- [Qwen2.5-VL](./I2T/Qwen2.5-VL/)

  基于 Qwen2.5-VL 实现图像识别转为自然语言文本

  通义千问新一代视觉语言大模型，基于原生动态分辨率与 2D RoPE 架构，支持复杂文档图表解析、视觉定位及小时级长视频理解，可高效实现跨模态结构化推理

- [InternVL3](./I2T/InternVL3/)

  基于 InternVL3 实现图像识别转为自然语言文本

  上海 AI 实验室开源的多模态大模型，兼具细粒度视觉感知、长视频理解与工业级 OCR 能力，适合在 GUI 智能体控制、3D 空间感知及复杂工具调用等场景
